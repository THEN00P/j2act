package com.example.tsnpm.pages;

import static com.example.tsnpm.components.NoteEditor.noteEditor;
import static com.example.tsnpm.components.SalesChart.salesChart;
...
public class HomePage extends LiveComponent implements Page {
  ...
  @Override public HtmlTag render() {
    return html(
      head(
        title("j2act · TypeScript with npm")
      ),
      body(
        h1("TypeScript client modules, bundled from npm"),
        section(
